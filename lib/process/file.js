 ...
 * @module {function} bit-docs/lib/process/file file
 *
 * Processes a file's source. Adds created [bit-docs/types/docObject]s to
 * docMap.
 *
 * @signature `processFile(source, docMap, [filename])`
 *
